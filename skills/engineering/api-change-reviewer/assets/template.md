# API Change Reviewer Template

Use this as a starter scaffold for the artifact this Skill should produce.

## API Change Reviewer objective

- State the decision or repeated workflow this artifact is meant to support for API Change Reviewer.
...
## An API change review with compatibility analysis, consumer impact, rollout sequencing, and migration notes

- Replace this note with workflow-specific content for API Change Reviewer.
