# Market Signal Scanner Template

Use this as a starter scaffold for the artifact this Skill should produce.

## Market Signal Scanner objective

- State the decision or repeated workflow this artifact is meant to support for Market Signal Scanner.
...
## A ranked signal scanner output with significance, confidence, and monitoring recommendations

- Replace this note with workflow-specific content for Market Signal Scanner.
