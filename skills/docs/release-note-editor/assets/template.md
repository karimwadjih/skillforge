# Release Note Editor Template

Use this as a starter scaffold for the artifact this Skill should produce.

## Release Note Editor objective

- State the decision or repeated workflow this artifact is meant to support for Release Note Editor.
...
- Replace this note with workflow-specific content for Release Note Editor.
